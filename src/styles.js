const styles = {
  ...
  heroHeadText:
    'font-black text-eerieBlack lg:text-[80px] sm:text-[60px] xs:text-[25px] text-[25px] lg:leading-[80px] mt-2',
  heroSubText:
    'text-eerieBlack font-medium lg:text-[26px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[35px]',
